            ...
            <div class="mb-3 col-md-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" placeholder="Telp" name="no_hp"
                  value="<?php echo $this->session->userdata('no_hp'); ?>">
              </div>
            </div>
            <div class="mb-3 col-md-6" <?php if ( $this->session->userdata('level')=='Pembeli') { echo 'hidden'; } ?>>
              <label for="address" class="form-label">Tempat Lahir</label>
              <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir"
                value="<?php echo $this->session->userdata('tempat_lahir'); ?>">
            </div>
            <div class="mb-3 col-md-6" <?php if ( $this->session->userdata('level')=='Pembeli') { echo 'hidden'; } ?>>
              <label for="state" class="form-label">Tanggal Lahir</label>
              <input type="date" class="form-control" placeholder="Tempat Lahir" name="tanggal_lahir"
                value="<?php echo $this->session->userdata('tanggal_lahir'); ?>">
            </div>
            <div class="mb-3 col-md-6" <?php if ( $this->session->userdata('level')=='Pembeli') { echo 'hidden'; } ?>>
              <label for="address" class="form-label">Kelas</label>
              <input type="text" class="form-control" placeholder="Kelas" name="kelas"
                value="<?php echo $this->session->userdata('kelas'); ?>" readonly>
            </div>
            <div class="mb-3 col-md-6" <?php if ( $this->session->userdata('level')=='Pembeli') { echo 'hidden'; } ?>>
              ...
              <input type="number" class="form-control" placeholder="Tahun Masuk" name="tahun_masuk"
                value="<?php echo $this->session->userdata('tahun_masuk'); ?>" readonly>
            </div>
