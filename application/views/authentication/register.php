            ...
            <div class="card-body">
              ...
              <form class="form-horizontal" method="post" action="<?php echo site_url('auth/simpan');?>">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="username" placeholder="Masukan 4-digit dari Sekolah" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="no_hp" placeholder="Contoh penulisan 6289673333...">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="tahun_masuk" placeholder="Tahun masuk SMKN 2 Karanganyar" >
                </div>
                <div class="mb-3">
